...
export default function App() {
  ...
  const providers: (Provider | typeof ALL)[] = [ALL, 'OpenAI', 'Anthropic', 'Google', 'GitHub', 'OpenRouter', 'Moonshot AI', 'Xiaomi', 'Alibaba', 'x.ai'];
    ...
    <div className="app">
      ...
      <header className="header">
        <div className="header-inner">
          ...
          <span className="header-badge">Updated August 2026</span>
        </div>
      </header>
      ...
      <main className="main">
        ...
        <section className="hero">
          ...
          <div className="hero-meta">
            ...
            <span className="hero-pill">📅 26 Aug 2026</span>
          </div>
        </section>
      ...
      <footer>
        <p>
          ...
          . Prices as of 26 August 2026. Not affiliated with GitHub or OpenRouter.
        </p>
      </footer>
    </div>
  );
